...
const Footer = () => {
  return (
    <div className="text-white mt-4 max-md:text-[12px] p-5 font-bold w-full h-[300px] md:h-[255px] bg-primary2 flex items-center md:justify-around max-md:justify-between animate-fade-up animate-once -z-10">
      {/* info */}
